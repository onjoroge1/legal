...
const seoBySlug: Record<string, DocumentSeo> = {
  "non-disclosure-agreement": {
    ...
    description:
      "Create a Non-Disclosure Agreement draft online with state-aware inputs and PDF or DOCX download. Attorney review required before use.",
    ogTitle: "Non-Disclosure Agreement (NDA) Generator",
    ogDescription: "Build an AI-assisted NDA draft with state-aware inputs and attorney review required before use.",
  ...
  "llc-operating-agreement": {
    ...
    description:
      "Create an LLC Operating Agreement draft covering ownership, management, and distributions with state-aware review notes.",
  ...
  "employment-contract": {
    ...
    description:
      "Create an employment contract draft online with state-aware inputs. Define role, pay, benefits, and termination for attorney review.",
  ...
  "residential-lease-agreement": {
    ...
    description:
      "Create a residential lease draft covering rent, term, deposits, and policies with state-aware disclosure review prompts.",
  ...
  "independent-contractor-agreement": {
    ...
    description:
      "Create an independent contractor agreement draft covering scope, payment, and IP ownership with state-aware review notes.",
  ...
  "demand-letter": {
    ...
    description:
      "Create a demand letter draft online. Organize a request for payment or action for attorney review before sending. PDF download available.",
  ...
  "landlord-notice-to-vacate": {
    ...
    description:
      "Create a landlord notice-to-vacate draft online with state-aware notice-period and statutory-language review prompts.",
    ogTitle: "Landlord Notice to Vacate Generator",
    ogDescription: "Generate a state-aware notice-to-vacate draft and verify current statutory language before use.",
    ogImage: DEFAULT_IMAGE,
  ...
  "promissory-note": {
    ...
    description:
      "Create a promissory note draft online with principal, interest, payment schedule, and default terms for attorney review.",
    ogTitle: "Promissory Note Generator",
    ogDescription: "Prepare a promissory note draft with clear repayment terms for review.",
    ogImage: DEFAULT_IMAGE,
  ...
  "general-release-of-liability": {
    ...
    description:
      "Create a general release-of-liability draft online and have an attorney assess enforceability before use.",
  ...
  "vehicle-bill-of-sale": {
    ...
    description:
      "Create a state-aware vehicle bill-of-sale draft with VIN, odometer, and DMV-field review prompts.",
  ...
  "mutual-non-disclosure-agreement": {
    ...
    description:
      "Create a mutual NDA draft online for confidential information shared in both directions. State-aware inputs and PDF download available.",
    ogTitle: "Mutual NDA Generator — Bilateral Non-Disclosure Agreement",
    ogDescription: "Build a mutual NDA draft with state-aware inputs and attorney review required before use.",
    ogImage: DEFAULT_IMAGE,
  ...
  "unilateral-non-disclosure-agreement": {
    ...
    description:
      "Create a one-way NDA draft for information shared with vendors, employees, or partners. State-aware inputs; attorney review required.",
  ...
  "single-member-llc-operating-agreement": {
    ...
    description:
      "Create a single-member LLC operating agreement draft with state-aware questions about management rules, distributions, and liability provisions.",
  ...
  "multi-member-llc-operating-agreement": {
    ...
    description:
      "Create a multi-member LLC operating agreement draft covering ownership, voting, distributions, and exits with state-aware review notes.",
  ...
  "at-will-employment-contract": {
    ...
    description:
      "Create an at-will employment contract draft covering compensation, benefits, policies, and at-will language for attorney review.",
  ...
  "employee-non-disclosure-agreement": {
    ...
    description:
      "Create an employee NDA draft addressing trade secrets, client lists, and proprietary information for attorney review.",
  ...
  "asset-purchase-agreement": {
    ...
    description:
      "Create an asset purchase agreement draft covering equipment, inventory, IP, goodwill, and other deal terms for attorney review.",
  ...
  "sublease-agreement": {
    ...
    description:
      "Create a sublease agreement draft addressing the subtenant and your obligations to the original landlord.",
