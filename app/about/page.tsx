...
const values = [
  ...
  {
    icon: Lightbulb,
    title: "AI With Attorney Oversight",
    description:
      "Our documents are generated by AI trained on attorney-reviewed frameworks, updated regularly to reflect current state and federal law. Technology and legal expertise working together.",
  },
  {
    icon: Heart,
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <p className="mt-4 leading-relaxed text-muted-foreground">
                Our mission is to close that gap. By combining advanced AI with attorney-reviewed
                document frameworks, we generate state-specific, legally structured documents in
                minutes — for a fraction of traditional legal costs.
              </p>
              <p className="mt-4 leading-relaxed text-muted-foreground">
                Every template on our platform is built on frameworks reviewed by licensed attorneys,
                updated to reflect current law, and designed to be clear and enforceable.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  description:
                    "Browse over 100 attorney-reviewed document templates across business, employment, real estate, estate planning, and more.",
                },
                {
                  step: "02",
