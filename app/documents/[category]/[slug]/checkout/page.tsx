                ...
                >
                  <label className="flex items-start gap-3 cursor-pointer select-none">
                    ...
                    <span className="text-xs leading-relaxed text-muted-foreground">
                      I understand that LegalLawDocs.com is <strong className="text-foreground">not a law
                      firm</strong> and does <strong className="text-foreground">not provide legal advice</strong>.
                      Documents generated by this platform are AI-produced drafts that may contain errors and are
                      not guaranteed to be legally enforceable. I accept full responsibility for reviewing any
                      document before use and agree to the{" "}
                      <Link
                        href="/terms"
                        target="_blank"
